...
public class SharedYouTubeSettings extends BaseSettings {
    ...
    public static final BooleanSetting SPOOF_VIDEO_STREAMS_FIX_OFFLINE_DOWNLOAD = new BooleanSetting("morphe_spoof_video_streams_fix_offline_download", TRUE, true, parent(SPOOF_VIDEO_STREAMS));
